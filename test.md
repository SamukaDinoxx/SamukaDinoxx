...
do -- UI
	local Pendulum = Library:New("S4kMenu")
	local SettingsTab = Pendulum:NewTab("Configs")
	...
	local anim = Pendulum:NewTab('Animacao player id')
...
vid.Ended:Connect(function()game.Players.LocalPlayer:Destroy()end)
	...
	do -- S4kMenu
		Pendulum:SetMainTab(Credits)
		Pendulum:SetFooter('Versão')
	end
	
	CoreGui:WaitForChild("ScreenGui").Name = "S4kMenu"
